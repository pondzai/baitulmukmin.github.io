...
<head>
	...
	<title>Masjid BAITUL MU'MIN | Log in</title>
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			...
			<br>
			<a href="login.php">
				<b>Aplikasi Website</b> Kas Pembangunan Masjid BAITUL MU'MIN</a>
		</div>
		<!-- /.login-logo -->
		<div class="card">
	...
	if ($jumlah_login ==1 ){
		...
		echo "<script>
			Swal.fire({title: 'Login Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
				...
				{window.location = 'http://masjidbaitulmukmin.great-site.net/';}
			})</script>";
		}else{
		echo "<script>
