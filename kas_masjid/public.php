...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">CP : 0895413326142</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="?page=home" class="nav-link">
              ...
              <p>
                Dashboard
                <span class="badge badge-warning right">2 Informasi</span>
              </p>
            </a>
          </li>
  ...
  <footer class="main-footer">
    ...
    Copyright &copy;<a target="_blank" href="https://www.facebook.com/radenmas.brono"><strong> RENOVASI BERSAMA</strong></a>
    Supported by 48g.
  </footer>
