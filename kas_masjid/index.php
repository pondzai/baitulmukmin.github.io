...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-default navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="http://masjidbaitulmukmin.great-site.net/" class="nav-link">Home</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="http://masjidbaitulmukmin.great-site.net/" class="brand-link">
				<img src="dist/img/masjid.jpg" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text font-weight-light"> Masjid BAITUL MU'MIN</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="http://masjidbaitulmukmin.great-site.net/" class="d-block">
							<?php echo $data_nama; ?>
						</a>
        ...
        ?>
						<li class="nav-item">
							<a href="http://masjidbaitulmukmin.great-site.net/" class="nav-link">
    ...
    ?>
		...
		<footer class="main-footer">
			...
			Masjid BAITUL MU'MIN | Karang Panas II
			</div>
			Copyright &copy;
			<a target="_blank" href="https://www.facebook.com/radenmas.brono">
				<strong> RENOVASI BERSAMA</strong>
			</a>
			| Remaja Masjid.
		</footer>
